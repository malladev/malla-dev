        ...
        <div className="mx-auto max-w-2xl sm:py-20 py-10 sm:px-10">
          ...
          <div className="text-center sm:px-0 px-5">
            ...
            <p className="mt-6 sm:text-lg text-sm leading-8 text-gray-400">
              ...
              convaincantes, je suis un Développeur FULLSATCK et UX / UI
              Designer avec une approche holistique. Je combine mes compétences
              techniques et créatives pour proposer des solutions web ou mobiles
              complètes.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a href="#" target="_blank" className="flex items-center gap-1 hover:-translate-y-1 hover:translate-x-1 hover:transition-transform duration-500">
                <svg
